                            ...
                            <div class="row clearfix">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <ul class="mail_list list-group list-unstyled">
                                        ...
                                        <li
                                            class="list-group-item @if($notifikasi->is_dibaca === 'tidak_dibaca') unread @endif">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <div class="controls">
                                                        <div class="checkbox">
                                                ...
                                                <div class="media-body">
                                                    <div class="media-heading">
                                                        <a href="{{ route('notifikasi.detail', $notifikasi->id_notifikasi) }}"
                                                            class="m-r-10">{{ $notifikasi->judul }}</a>
                                                        ...
                                                        <small class="float-right text-muted"><time
                                                                ...
                                                                datetime="{{ $notifikasi->created_at->tz('Asia/Jakarta')->format('d M Y, H:i:s') }}">{{ $notifikasi->created_at->tz('Asia/Jakarta')->format('d M Y, H:i:s') }}</time><i
