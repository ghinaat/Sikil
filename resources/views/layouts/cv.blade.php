        ...
        <div class="header">
            <table>
                <tr>
                    ...
                    <td style="width:50%;">
                        <h5 style="margin-top: -40px;">The Southeast Asian Ministers of Education Organization (SEAMEO) <br> SEAMEO Regional Center for Quality Improvement of Teachers and Education Personnel (QITEP) in Language (SEAQIL) </h5>        
                    </td>
                </tr>
            </table>
