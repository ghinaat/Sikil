...
// Route::delete('/kegiatan/timkegiatan/{id_tim}', [KegiatanController::class, 'destroyTimKegiatan'])
    ->name('kegiatan.destroyTimKegiatan');
Route::delete('/kegiatan/{id_kegiatan}/destroy-timkegiatan/{id_tim}', [KegiatanController::class, 'destroyTimKegiatan'])
    ->name('kegiatan.destroyTimKegiatan')
